...
CREATE TABLE `__new_transactions` (
	...
	`type` text NOT NULL,
	`date` integer DEFAULT '"2026-03-13T07:14:38.218Z"' NOT NULL
);
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-03-13T07:14:38.218Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-13T07:14:38.218Z"' NOT NULL
);
--> statement-breakpoint
