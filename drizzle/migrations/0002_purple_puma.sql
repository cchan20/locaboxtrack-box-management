...
CREATE TABLE `__new_transactions` (
	...
	`type` text NOT NULL,
	`date` integer DEFAULT '"2026-03-13T07:55:04.795Z"' NOT NULL
);
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-03-13T07:55:04.795Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-13T07:55:04.795Z"' NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE `customers` ADD `external_id` text;