...
CREATE TABLE `__new_transactions` (
	...
	`type` text NOT NULL,
	`date` integer DEFAULT '"2026-03-16T06:39:23.105Z"' NOT NULL
);
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-03-16T06:39:23.104Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-16T06:39:23.104Z"' NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE `customers` ADD `risk_status` text DEFAULT 'low' NOT NULL;